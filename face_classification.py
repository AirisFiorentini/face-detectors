...
def split_data3(data, images_per_person_in_train=5, images_per_person_in_test=1):
    images_per_person = 10
    images_all = len(data[0])
...
def cross_validation3(data, method, folds=3):
    if folds < 3:
        folds = 3
    images_per_folder = 10
    per_fold = int(images_per_folder / folds)
    x_train = []
    x_test = []
    y_train = []
    y_test = []
    ...
    for step in range(0, folds):
        ...
        if step == 0:
            for i in range(0, 40):
                print(i)
                if i == 0:
                    x_train += data[0][per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                    x_test += data[0][i * images_per_folder:per_fold + i * images_per_folder]
                    y_train += data[1][per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                    y_test += data[1][i * images_per_folder:per_fold + i * images_per_folder]
                elif i == 39:
                    x_train += data[0][per_fold + i * images_per_folder:]
                    x_test += data[0][i * images_per_folder:per_fold + i * images_per_folder]
                    y_train += data[1][per_fold + i * images_per_folder:]
                    y_test += data[1][i * images_per_folder:per_fold + i * images_per_folder]
                else:
                    x_train += data[0][per_fold + i * images_per_folder: (i + 1) * images_per_folder]
                    x_test += data[0][i * images_per_folder:per_fold + i * images_per_folder]
            ...
            if step == folds - 1:
                for i in range(0, 40):
                    print(i)
                    if i == 0:
                        x_train += data[0][i * images_per_folder:step * per_fold + i * images_per_folder]
                        x_test += data[0][step * per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                        y_train += data[1][i * images_per_folder:step * per_fold + i * images_per_folder]
                        y_test += data[1][step * per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                    elif i == 39:
                        x_train += data[0][i * images_per_folder:step * per_fold + i * images_per_folder]
                        x_test += data[0][step * per_fold + i * images_per_folder:]
                        y_train += data[1][i * images_per_folder:step * per_fold + i * images_per_folder]
                        y_test += data[1][step * per_fold + i * images_per_folder:]
                    else:
                        x_train += data[0][i * images_per_folder:step * per_fold + i * images_per_folder]
                        x_test += data[0][step * per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                        y_train += data[1][i * images_per_folder:step * per_fold + i * images_per_folder]
                ...
                for i in range(0, 40):
                    print(i)
                    if i == 0:
                        x_train += data[0][i * images_per_folder:step * per_fold + i * images_per_folder] + data[0][(step + 1) * per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                        x_test += data[0][step * per_fold + i * images_per_folder:(step + 1) * per_fold + i * images_per_folder]
                        y_train += data[1][i * images_per_folder:step * per_fold + i * images_per_folder] + data[1][(step + 1) * per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                        y_test += data[1][step * per_fold + i * images_per_folder:(step + 1) * per_fold + i * images_per_folder]
                    if i == 39:
                        x_train += data[0][i * images_per_folder:step * per_fold + i * images_per_folder] + data[0][(step + 1) * per_fold + i * images_per_folder:]
                        x_test += data[0][step * per_fold + i * images_per_folder:(step + 1) * per_fold + i * images_per_folder]
                        y_train += data[1][i * images_per_folder:step * per_fold + i * images_per_folder] + data[1][(step + 1) * per_fold + i * images_per_folder:]
                        y_test += data[1][step * per_fold + i * images_per_folder:(step + 1) * per_fold + i * images_per_folder]
                    else:
                        x_train += data[0][i * images_per_folder:step * per_fold + i * images_per_folder] + data[0][(step + 1) * per_fold + i * images_per_folder:(i + 1) * images_per_folder]
                        x_test += data[0][step * per_fold + i * images_per_folder:(step + 1) * per_fold + i * images_per_folder]
